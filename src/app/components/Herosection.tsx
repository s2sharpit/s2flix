...
export default function Herosection({ title, imgUrl }: { title: string, imgUrl: string }) {
  return (
        ...
        <div className={styles.grid_two_section}>
          <div className={heroStyles.hero_content}>
            ...
            <p>
              ...
              got covered. Browse our selection of the latest and greatest
          ...
          <div className={heroStyles.hero_image}>
            <Image src={imgUrl} alt="home img" width={500} height={500} />
          </div>
        </div>
      </div>
